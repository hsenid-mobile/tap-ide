package hms.ctap.idea.plugin.action;
...
public class NewServiceClassAction extends CreateElementActionBase {
    ...
    public NewServiceClassAction() {
        super(message("ctap.receive.services.text"), message("ctap.receive.services.description"), ServiceClassIcon.Service);
    }
    ...
    private class MyDialog extends DialogWrapper {
        ...
        public MyDialog(final Project project,
            ...
            setTitle(message("ctap.receive.services.wizard.title"));
        ...
        protected void doOKAction() {
            ...
            if (myValidator.checkInput(inputString) && myValidator.canClose(inputString)) {
                ...
                errorText.setError(message("ctap.create.class.incorrect.name"));
            }
            //close(OK_EXIT_CODE);
        }
