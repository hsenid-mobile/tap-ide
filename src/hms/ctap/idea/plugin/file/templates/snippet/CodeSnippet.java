...
public enum CodeSnippet {
    ...
    USSD_SESSION_PROCESSOR("UssdMessageProcessor %s = new UssdMessageProcessor.Builder().appConfig(new AppConfig.Builder().appId(\"APP_xxxxxx\").password(\"xxxxxx\").build()).menus(Arrays.<Menu>asList(new DefaultFirstMenu())).build();", "ussdMessageProcessor", Arrays.asList("hms.tap.ussd.manager.UssdMessageProcessor", "hms.tap.ussd.manager.conf.AppConfig", "hms.tap.ussd.manager.menu.DefaultFirstMenu", "hms.tap.ussd.manager.menu.Menu"));
